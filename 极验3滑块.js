...
var traceVar = {
    "lang": "zh-cn",
    "userresponse": "55aa655555566a5633ec9",
    "passtime": 643,
    "imgload": 1597,
    "aa": "T(!!Issssssssswsssssstsssswssss0hsssssssssvssssssswssswssstssjss(!!(X/,..-*-.,**-,,*-,**,*),):--,,-..*///*010-11*.-2.-3038AL7$-S",
    "ep": {
        "v": "7.9.3",
        "$_BIT": false,
        "me": true,
    ...
    "h9s9": "1816378497",
    "rp": "5348e1b89031573e2622d079cd353d2b"
}
...
var get_trace = function (traceArr) {
...
function get_w(x, challenge2, passTime, traceArr, c, s, gt) {
    let aeskey = rt()
    traceVar.userresponse = H(x, challenge2);
    traceVar.passtime = passTime;
    traceVar.aa = get_aa(get_trace(traceArr), c, s);
    traceArr.rp = CryptoJs.MD5(gt + challenge2['slice'](0, 32) + passTime).toString();
    console.log()
    var u = new U()['encrypt'](aeskey)
        , l = V['encrypt'](JSON.stringify(traceVar), aeskey)
        , h = m['$_FEu'](l)
    return h + u;
}

// console.log(get_w(132, "dbb527cb89f1225dd39cae9e2e898698cf"));
// let trace_arr = [
//     [
//         -31,
//         -24,
...
// ]
// let s = '6b2e7e62'
// console.log(get_aa(get_trace(trace_arr), c, s));
// console.log(CryptoJs.MD5('019924a82c70bb123aae90d483087f94' + '0216426cc6a25f74456b02aa2f84e9df' + 1017).toString());
