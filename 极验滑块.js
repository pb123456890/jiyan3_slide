...
var U = function () {
    ...
    return m[$_IBAZ(232)][$_IBAZ(342)] = function O(t) {
        ...
        y[$_IBAZ(232)][$_IBAZ(390)] = function G(t, e) {
            ...
            $_JDDn.shift();
            var $_JDGX = $_JDDn[0];
            var n, r = t % this[$_JDFX(332)], i = this[$_JDEa(332)] - r, o = (1 << i) - 1,
                s = Math[$_JDFX(202)](t / this[$_JDEa(332)]), a = this[$_JDFX(385)] << r & this[$_JDEa(370)];
        ...
        y[$_IAJj(232)][$_IBAZ(225)] = function $_GQ(t) {
            ...
            var n, r = (1 << e) - 1, i = !1, o = $_JIAH(0), s = this[$_JIAH(339)],
                a = this[$_JIAH(332)] - s * this[$_JIAH(332)] % e;
            if (0 < s--) {
...
// userresponse = H(移动距离, challenge)

// var o = {
//     "lang": "zh-cn",
//     "userresponse": "ee777e777ec04",
//     "passtime": 146,
//     "imgload": 122,
//     "aa": "T(!!HssHsssssssssssssssssssssstssssssssssssssDssssssstsss(!!(G.*---),,*,)***)k),(***)*)*)**))**))*S****)***,,.*./4",
//     "ep": {
//         "v": "7.9.3",
//         "$_BIT": false,
//         "me": true,
...
//     },
//     "h9s9": "1816378497",
//     "rp": "3f9662e1df0d60bb0d8825f1260b27c7"
// }


var traceVar = {
    "lang": "zh-cn",
    "userresponse": "fdfffdffdfff8319",
    "passtime": 802,
    "imgload": 95,
    "aa": "X,,D(!!Ixsxsssxssxssstxstsssyxstsszssstsst!.)ssstustssttssy!)sttsst!)ysstAtssstsyssyttssssssssswswwJssstsswsssssswssssw(!!(-@)*-)))*))))*g))**))))))))*)))))))))))))))))))))))*))*(9)())))))))).())***)*)),**-4U)8$):310.,-*..,.0*-/3F5$.r",
    "ep": {
        "v": "7.9.3",
        "$_BIT": false,
        "me": true,
    ...
    "h9s9": "1816378497",
    "rp": "524ba1da52288a14c350fbf44da1a04a"
}
...
function get_w(x, challenge2, passTime, trace_arr, c, s, gt) {
    traceVar.userresponse = H(x, challenge2);
    traceVar.passtime = passTime;
    traceVar.aa = get_aa(get_trace(trace_arr), c, s);
    traceVar.rp = CryptoJs.MD5(gt + challenge2['slice'](0, 32) + passTime).toString();
    // 此处是一个陷阱，u和l如果都使用rt()，生成的字符串不一致，导致"param decrypt error"的问题
    var key = rt();
    var u = new U()['encrypt'](key)
        , l = V['encrypt'](yt['stringify'](traceVar), key)
        , h = m['$_FEu'](l)
    return h + u;
    // var u = new U()['encrypt'](rt())
    //     , l = V['encrypt'](yt['stringify'](o), rt())
    //     , h = m['$_FEu'](l)
    // var w = h + u;
    // return w;
}
